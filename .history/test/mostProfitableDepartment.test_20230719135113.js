...
describe("Test my mostProfitableDepartment function", function () {
    it("It should return a string that states outdoor is the most profitable department", function () {
      assert.deepEqual(
        'outdoor',
    ...
    it("It should return a string stating that electronics is the most profitable department", function () {
